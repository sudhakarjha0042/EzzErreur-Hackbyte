  ...
  " flex w-full items-center justify-center cursor-pointer gap-2",
  {
    variants: {
      variant: {
        ...
        darkOutlined:
          "border-dark-secondary border bg-dark-primary text-borderPrimary",
        darkDisabled: "bg-dark-secondary text-dark-placeholder",
      },
      size: {
        default: " h-10 rounded-md px-3 py-4 font-medium text-[1rem]",
      },
    },
    defaultVariants: {
      variant: "primary",
...
const Button = forwardRef(
  (
    { className, size, variant: buttonVariant, disabled, isLoading, ...props },
    ref
  ) => {
